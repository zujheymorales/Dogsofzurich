...
# Load the dataset 
# Use latin1 to handle special characters like é, ä, ü
csv_path = r"C:\Users\aryma\OneDrive\Documents\GitHub\Dogsofzurich\info\dogsofzurich2015.csv"
...
# Show top values for some key columns (if they exist) 
...
# Load the cleaned file again (already working) 
csv_path = r"C:\Users\aryma\OneDrive\Documents\GitHub\Dogsofzurich\info\dogsofzurich2015.csv"
df = pd.read_csv(csv_path, encoding="latin1")
...
# Fill in missing numeric values (CITY_ID, CITY_DISTRICT)
...
# Simplify breeds (too many unique values) 
...
cleaned_path = r"C:\Users\aryma\OneDrive\Documents\GitHub\Dogsofzurich\info\dogs_cleaned.csv"
